...
public class AdapterThumbnail extends RecyclerView.Adapter<AdapterThumbnail.ThumbnailVH> {
    ...
    private final ArrayList<String> tableImage;

    public AdapterThumbnail(@NotNull ArrayList<String> tableImage, @NotNull OnClickCallBack onThumbnailClick) {
...
//        if (tableImage.get(0) != null) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                onThumbnailClick.OnThumbnailClick(tableImage.get(position));
